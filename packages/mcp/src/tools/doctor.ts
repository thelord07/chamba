...
const DESCRIPTION =
  ...
  'agent config validity, the Obsidian vault connection, the MCP registration (warns on ' +
  'duplicate/inconsistent chamba entries across editor configs), the log directory, and ' +
